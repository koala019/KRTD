...
resources.load([
    ...
    'images/ZombieWalk_normal_scaled_slower.gif',
    'images/map.png',
]);
...
var player = {
    speed: 2,
    pos: {x:1024, y:((gameCanvas.height / 2)+100)},
...
for (var i = 0; i < 10; i++) {
    enemies.push({
        pos: {x: (enemiesPos.x)-(i*60), y: enemiesPos.y},
        speed: 200,
        dir: 0,
        health: 5,
...
function update(dt) {
    ...
    var rioterPath = [{x: 303, y:417}, {x:306}];
